        ...
        <div>
          {bookings.length === 0 ? (
            <div className='text-center py-20'>
              ...
              <p className='text-gray-500 mt-2'>You haven't made any reservations.</p>
            </div>
          ) : (
            bookings.map((booking, index)=>(
              ...
              p-6 border border-borderColor rounded-lg mt-5 first:mt-12'>
                ...
                <div className='md:col-span-1'>
                  ...
                  <p className='text-gray-500'>{booking.car.year} . {booking
                    .car.category} . {booking.car.location}</p>
                </div>
