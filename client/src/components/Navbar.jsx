  ...
  duration-300 z-50 ${
    location.pathname === "/" ? "bg-light" : "bg-white"
            ...
            <div className='flex max-sm:flex-col items-start sm:items-center gap-6'>
              ...
              changeRole()} className="cursor-pointer">{isOwner ?
              'Dashboard' : 'List cars'}</button>

              <button onClick={()=> {user ? logout() : setShowLogin
              (true)}} className='cursor-pointer px-8 py-2 bg-primary
